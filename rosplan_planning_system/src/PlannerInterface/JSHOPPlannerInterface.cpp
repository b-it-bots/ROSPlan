#include "rosplan_planning_system/PlannerInterface/JSHOPPlannerInterface.h"
...
namespace KCL_rosplan
{
	...
	/* constructor */
	/*-------------*/
	JSHOPPlannerInterface::JSHOPPlannerInterface(ros::NodeHandle& nh)
	{
		node_handle = &nh;
	...
	JSHOPPlannerInterface::~JSHOPPlannerInterface()
	{
		delete plan_server;
	}
	 ...
	 */
	std::string JSHOPPlannerInterface::runCommand(std::string cmd)
    {
		std::string data;
		FILE *stream;
		char buffer[1000];
	 ...
	 */
	bool JSHOPPlannerInterface::runPlanner()
    {
		// save problem to file for JSHOP2
...
int main(int argc, char **argv)
{
	...
	KCL_rosplan::JSHOPPlannerInterface pi(nh);
