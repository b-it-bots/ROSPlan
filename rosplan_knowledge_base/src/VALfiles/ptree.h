...
class task_list: public pc_list<task*>
{
public:
    virtual ~task_list() {};
};

class task : public parse_category {
public:
	virtual void visit(VisitController * v) const;
};
...
class comparison : public goal, public binary_expression // proposition? // No, function inequality, eg. (> a b) --mc
{
private:
    comparison_op op;
